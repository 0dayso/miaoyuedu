        ...
        <div  class="user">
            ...
            <div class="rt">
                <div class="rt_unit rt_cz clearfix">
                    <div class="rt_cz_yue"><h2>账户余额：<span class="cpink2">{$userinfo.money}</span>{:C("SITECONFIG.MONEY_NAME")}</h2></div>
                    <div class="user_tit"><h1>账号充值</h1></div>
                    <div class="rt_cz_methods clearfix">
                        <div class="rt_cz_methods_tit">选择充值方式：</div>
                        <ul>
                            <li><a href="javascript:void(0);" payway="ALIPAY_WAP" name="payway" class="cz_zfb radius4 active"></a><p>1元=<span class="cpink2">100</span>{:C("SITECONFIG.MONEY_NAME")}</p></li>
                            <li><a href="javascript:void(0);" payway="WEIXINPAY" name="payway" class="cz_wx radius4"></a><p>1元=<span class="cpink2">100</span>{:C("SITECONFIG.MONEY_NAME")}</p></li>
                        </ul>
                    </div>
                    ...
                    <div class="rt_cz_result">
                        您将支付<span class="cpink2" id="rmb">10</span>元 ，可获得<span class="cpink2" id="money">1000</span>{:C("SITECONFIG.MONEY_NAME")}<button class="mainbtn radius4 disable" id="tijiao" disabled="disabled">暂不提供充值</button>
                    </div>
                    <div class="ts cz_ts">
