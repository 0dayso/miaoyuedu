...
<div class="unit">
    <div class="frame10 comments">
        <ul>
            <li >
                <div class="lf"><if condition="$commentinfo.avatar neq ''"><img src="{$commentinfo.avatar}"/><else/><img src="__IMG__/avater.jpg" /></if></div>
                <div class="rt">
    ...
    {{if list}}
        {{each list as row i}}
            ...
            <li>
                ...
                <div class="rt">
                    <h4>{{row.nickname}}{{if row.highlight_flag == 1}}<span class="ic_jh">精华</span>{{/if}}{{if row.lcomment == 1}}<span class="ic_cp">长评</span>{{/if}}<span class="lou flrt">{{if row.floor}}{{row.floor}}楼{{/if}}</span></h4>
            ...
            <li>
                <div class="lf">{{if row.avatar}}<img src="{{row.avatar}}" />{{else}}<img src="__IMG__/avater.jpg" />{{/if}}</div>
                <div class="rt">
                    <h4>{{row.nickname}}{{if row.highlight_flag == 1}}<span class="ic_jh">精华</span>{{/if}}{{if row.lcomment == 1}}<span class="ic_cp">长评</span>{{/if}}<span class="lou flrt">{{row.floor}}楼</span></h4>
                     <p>{{row.content}}</p>
                     <p class="combom"><span class="fllf">{{row.time}}</span></p>
                </div>
            </li>
