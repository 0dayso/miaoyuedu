...
<block name="body">
<div class="login">
        <p><input id="text" type="text" placeholder="{$userinfo['nickname']}" class="radius4" name="username" id="input_user" <if condition="$ischanged neq FALSE">readonly="true"</if> /></p>
...
<if condition="$ischanged eq FALSE">
    function check(){
    ...
    var url = "{:url('Userajax/changenickname','','do')}";
    $.ajax({
        type:'post',
        url: url,
        data:data,
