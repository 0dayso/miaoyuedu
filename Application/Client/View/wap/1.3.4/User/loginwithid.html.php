...
<div class="login login2" style="margin-bottom: 50px;">
    ...
    <p><span><input name="checkbox" type="checkbox" checked="checked" class="checkbox" >记住登录密码</span><a href="{:url('User/losepwd',array('sex_flag'=>$sex_flag),'do')}" onClick="hg_gotoUrl('{:url('User/losepwd',array('sex_flag'=>$sex_flag),'do')}');" class="more">忘记密码？</a> </p>
</div>
<!--登录结束-->
