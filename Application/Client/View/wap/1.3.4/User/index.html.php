...
<!--更多按钮开始-->
<div class="unit">
<div class="more2  cpink noborder" onClick="hg_gotoUrl('{:url('User/logout',array('sex_flag'=>$sex_flag),'do')}')"><a href="{:url('User/logout',array('sex_flag'=>$sex_flag),'do')}">退出账号</a></div>
</div>
<!--更多按钮结束-->
</block>
<block name="script">
