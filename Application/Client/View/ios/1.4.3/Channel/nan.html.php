...
<block name="banner">
    <Hongshu:bangdan name="static_ios_ad_nan2">
        <div class="banner">
            {$row}
        </div>
    </Hongshu:bangdan>
...
<div class="unit ">
    <div class="frame4  clearfix">
        ...
        <foreach name="category" item="row">
            <li class="tag3" onClick="go_search('{$row['classid']}','nan')">{$row.title}</li>
        </foreach>
        </ul>
    </div>
</div>
...
<div class="unit">
    <div class="frame14 twobk clearfix">
        <ul>
            <li onClick="go_url('Channel/xinshu');"><h2 class="cgreen">男频新书</h2><p>最新免费小说免费看</p></li>
            <li onClick="go_url('Channel/tejia');"><h2 class="cyellow">天天特价</h2><p>热销小说免费</p></li>
        </ul>
    </div>
</div>
<!--新书和免费结束-->
...
<!--畅销榜结束-->
<div class="unit">
    <div class="like mbom40"> <a href="javascript:change_like('nv');"  class="flrt" ><span class="ic_set  fllf" ><img src="__IMG__/ic_set.png" /></span>我喜欢看女生小说></a></div>
</div>
</block>
<block name="script">
