...
<script>
            ...
            function go_login(){
                var url=parseUrl('','User/loginform','open//','html');
                doClient(url);
            }
...
<block name="body">
        <div class="mu2"></div>
            <div class="tkkj" id="main" style="display: none;">
                ...
                <p class="tkbtn"><a href="javascript:void(0);" onClick="auto_login(this);" class="ok">直接使用</a><a href="javascript:void(0);" class="no" onClick="go_login();">登录</a></p>
                </div>
            </div>
</block>
