...
<block name="body">
<form name="form" method="post" action="{:url('Userajax/saveautodingyue')}">
   <div class="unit">
    ...
    <div class="unit more2" style="text-align:center;">
        <a class="reviewmore" id="loadviewmore" href="javascript:void(0);" totalnum="0" total_page='0' pagenum='1' onClick="loadMoreautodingyuelist('{:U('Userajax/autodingyue')}');">更多</a>
    </div>
...
<script type="text/javascript">
    ...
    function loadMoreautodingyuelist(url) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#loadviewmore").html('<span>更多</span>');
    ...
    function updatebtn(obj) {
        ...
        lockbutton(obj);
        var gotourl = "{:U('Userajax/saveautodingyue')}";
        $.ajax({
            type: "POST",
            url: gotourl,
            data: "bid=" + bidarray,
    ...
    Do.ready('lazyload', function () {
        document.onscroll = function () {
            ...
            if((iScroll + $(window).height()+footHeight)>=$(document).height()){
                loadMoreautodingyuelist("{:url('Userajax/autodingyue')}");
                Lazy.Load();
            }
        }
    });
