...
function go_bookview(bid){
    var url=parseUrl({bid:bid},'Book/view','open//','do');
    doClient(url);
}
...
<if condition="$is_need_lingjiang gt 0">
    ...
    <li id="container">
      <div class="db">
        <div id="idx0" class="block" onclick="do_choujiang('0');">
            <div class="front side"> <img src="__IMG__/ic_wen.png" lazy="Y" /> </div>
            <div class="back side"> <img  id="backimg0" src="" lazy="Y" />
    ...
    <li id="container">
      <div class="db">
        <div id="idx1" class="block" onclick="do_choujiang('1');">
            <div class="front side"> <img src="__IMG__/ic_wen.png" lazy="Y" /> </div>
            <div class="back side"> <img id="backimg1" src="" lazy="Y" />
    ...
    <li id="container">
      <div class="db">
        <div id="idx2" class="block" onclick="do_choujiang('2');">
            <div class="front side"> <img  src="__IMG__/ic_wen.png" lazy="Y" /> </div>
            <div class="back side"> <img  id="backimg2" src="" lazy="Y" />
    ...
    <li id="container">
      <div class="db">
        <div id="idx3" class="block" onclick="do_choujiang('3');">
            <div class="front side"> <img  src="__IMG__/ic_wen.png" lazy="Y" /> </div>
            <div class="back side"> <img  id="backimg3" src="" lazy="Y" />
    ...
    <li id="container">
      <div class="db">
        <div id="idx4" class="block" onclick="do_choujiang('4');">
            <div class="front side"> <img  src="__IMG__/ic_wen.png" lazy="Y" /> </div>
            <div class="back side"> <img  id="backimg4" src="" lazy="Y" />
    ...
    <li id="container">
      <div class="db">
        <div id="idx5" class="block" onclick="do_choujiang('5');">
            <div class="front side"> <img  src="__IMG__/ic_wen.png" lazy="Y" /> </div>
            <div class="back side"> <img  id="backimg5" src="" lazy="Y" />
