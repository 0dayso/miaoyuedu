...
<div class="unit">
    <div class="hotproblem noborder">
        <ul>
            <li onClick="hg_gotoUrl('{:url('Help/index')}')"><h4>读者常见问题({$popularnum})</h4></li>
            <li onClick="hg_gotoUrl('{:url('Feedback/getfeedback',array('type'=>'private'))}')"><h4>我的问题(<span id="change">{$mynum}</span>)</h4></li>
        </ul>
    </div>
</div>
<!--底开始-->
