...
<block name="banner">
    <Hongshu:bangdan name="static_android_ad_nan">
        <div class="banner">
            {$row}
        </div>
    </Hongshu:bangdan>
...
<!--公告开始-->
<div class="unit">
    <div class="gongao tit" onClick="doChild('{:url('User/qiandao', array('action'=>'form'))}');"><p class="hidden "><span class="laba"><img src="__IMG__/ic_laba.png" /></span>每日签到，{:C('SITECONFIG.EMONEY_NAME')}免费得！</p></div>
</div>
<!--公告结束-->
<!--主编推荐开始-->
<div class="unit">
...
<!--今日免费开始-->
<div class="unit">
    <div class="tit"><h1>今日免费</h1><a href="javascript:doChild('{:url('Channel/free')}');" class="more">更多></a><span class="flrt mrt10"><em class="cred" id="timer"></em></span></div>
    <div class="frame2">
        <ul id="free1">
        </ul>
    </div>
...
<div class="unit ">
    <div class="frame4  clearfix">
        ...
        <foreach name="category" item="row">
            <li class="tag3" onClick="doChild('{:url('Channel/search',array('classid'=>$row['classid'],'isnewwin'=>1,'sex_flag'=>'nan'))}')">{$row.title}</li>
        </foreach>
        </ul>
    </div>
</div>
...
<div class="unit">
    <div class="frame14 twobk clearfix">
        <ul>
            <li onClick="doChild('{:url('Channel/xinshu',array('sex_flag'=>'nan'))}');"><h2 class="cgreen">男频新书</h2><p>最新免费小说免费看</p></li>
            <li onClick="doChild('{:url('Channel/tejia',array('sex_flag'=>'nan'))}');"><h2 class="cyellow">天天特价</h2><p>热销小说免费</p></li>
        </ul>
    </div>
</div>
<!--新书和免费结束-->
