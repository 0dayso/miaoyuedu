...
<div class="login login2">
        ...
        <p id="button1"><button type="button" class="radius4" onclick="check();">下一步</button></p>
        <p id="button2" style="display:none;"><button type="button" class="radius4" onclick="checksbm();">下一步</button></p>
        <p id="button3" style="display:none;"><button id="zc" type="button" class="radius4" onclick="login();">绑定</button></p>
</div>
</block>
<block name="script">
