 ...
 * @author: dingzi
 * @version: $Id: UserController.class.php 1580 2017-03-17 08:44:16Z guonong $
 */
...
class UserController extends Controller {
    ...
    public function logoutAction() {
        ...
        if ($islogout) {
            if(CLIENT_NAME == 'yqm' || CLIENT_NAME == 'myd' || CLIENT_NAME=='chushou') {
