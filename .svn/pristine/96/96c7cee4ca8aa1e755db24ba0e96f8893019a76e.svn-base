...
<div class="sign signtop clearfix">
    <span class="boxsizing"><php> echo intval(date('m'));</php>月</span>
            ...
            <div class="btn-qd" onClick="go_url('User/lingjiang')"><a class="signbtn radius4">签到</a></div>
            <elseif condition="intval($is_need_lingjiang) neq 0" />
            <div class="btn-qd" onClick="go_url('User/lingjiang')"><a class="signbtn radius4">抽奖({$is_need_lingjiang})</a></div>
            <else/>
