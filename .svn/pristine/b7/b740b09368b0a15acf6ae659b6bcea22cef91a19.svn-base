...
<!--目录开始-->
<div class="unit">
    <div class="readtit" onClick="go_url('{$bookinfo['bid']}','Book/chapterlist')">
            <h4>目录</h4>
...
<!--评论开始-->
<div class="unit">
    <div class="tit "><h1>精华评论</h1><a class="cpink flrt "><span class="ic_write" onClick="go_url('{$bookinfo['bid']}','Book/comment')" >我要评论</span></a></div>
                 ...
                 <li >
                       <div class="lf"><img src="__IMG__/avater.jpg" /></div>
                        ...
                        <if condition="$row.lcomment eq 1">
                         ...
                         <p class="cred" style="max-height:60px;overflow:hidden;">{$row.content}</p>
                        </div>
                 </li>
                    </if>
             <else/>
                 <li>
                        ...
                        <p style="max-height:60px;overflow:hidden;">{$row.content}</p>
                        </div>
                </li>
             </if>
    ...
    <div class="morecom"><a class="cyellow" onClick="go_url('{$bookinfo['bid']}','Book/comment')">更多书评></a></div>
</div>
<!--评论结束-->
...
<div class="statebtn4">
    ...
    <div class="lf">
        <div class="statebtn01 statebtn" onClick="go_url('{$bookinfo['bid']}','Book/dashang')"><img src="__IMG__/ic_gift.png" /><span>打赏</span></div>
        <div id="down"><div class="statebtn02 statebtn" onClick="do_download_book({$bookinfo['bid']})"><img src="__IMG__/ic_file_download.png?v=20160928" /><span>下载</span></div></div>
    </div>
...
<script type="text/html" id="tpl2">
    <div class="statebtn02 statebtn statebtn02dis"><img src="__IMG__/ic_file_download.png?v=20160919"/><span>限免中</span>
</script>
