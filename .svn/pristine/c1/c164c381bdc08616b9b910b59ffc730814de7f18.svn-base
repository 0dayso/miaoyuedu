...
<div class="main top20 bom40">
    <div class="help1200">
        <div class="helplist960">
            <p class="help_nav"><a class="c9" href="{:url('Index/index','','html')}">首页</a> > <a class="c9" href="{:url('Help/index','','html')}">帮助中心</a> > <a class="c9">{$aboutarticle.title}</a></p>
            <h4 class="c3 bom40">{$aboutarticle.title}</h4>
            <div class="help_wd">
