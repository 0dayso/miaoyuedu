...
<!--评论开始-->
<div class="unit">
    <div class="tit "><h1>精华评论</h1><a class="cpink flrt "><span class="ic_write" onClick="hg_gotoUrl('{:url('Book/comment',array('bid'=>$bookinfo['bid']))}')" >我要评论</span></a></div>
...
<div class="unit">
    ...
    <div class="frame2 mbom40 clearfix">
        <ul>
        <php>$_i = 0;</php>
        <Hongshu:bangdan name="android_xinshunv_xinshumianfendu" items="4">
...
<div class="statebtn4">
    ...
    <div class="lf">
        ...
        <div id="down">
        <div class="statebtn02 statebtn" onClick="do_download_book({$bookinfo['bid']})"><img src="__IMG__/ic_file_download.png?v=20160919" /><span>下载</span></div>
        </div>
    </div>
    ...
    <div class="statebtn04 statebtn" onClick="do_onlineRead_book({$bookinfo['bid']})"><img src="__IMG__/ic_local_library.png" /><span id="readname">立即阅读</span></div>
    </div>
</div>
<!--底部四个按钮结束-->
</block>
...
var is_login=hsConfig.USERINFO.islogin;
    ...
    function do_download_book() {
                ...
                var params = '{$doClinetstr}';
                if(params){
                 Do.ready('functions', function(){
                     doClient('download', params);
               });
                }
}
    ...
    $.ajax({
        ...
        success: function (data){
            ...
            if(data.isxiajia){
                ...
                $('.readtit').attr("onclick","hg_gotoUrl('{:url('Book/xiajia')}')");
...
<script type="text/html" id="tpl1">
   <div class="statebtn02 statebtn" style="background-color:#f0f0f0;"><img src="__IMG__/ic_file_download.png?v=20160919"/><span>限免中</span></div>
</script>
<script type="text/html" id="xiajia_tpl">
    <div class="lf">
        ...
        <div class="statebtn02 statebtn" onClick="hg_gotoUrl('{:url('Book/xiajia')}')"><img src="__IMG__/ic_file_download.png?v=20160919" /><span>下载</span></div>
    </div>
    <div class="statebtn03 statebtn " onClick="hg_gotoUrl('{:url('Book/xiajia')}')" id="sc"><img src="__IMG__/ic_favorite.png" /><span>收藏</span></div>
    <div class="statebtn04 statebtn" onClick="hg_gotoUrl('{:url('Book/xiajia')}')"><img src="__IMG__/ic_local_library.png" /><span>立即阅读</span></div>
</script>
</block>
