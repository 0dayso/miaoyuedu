...
<!--我喜欢开始-->
<div class="unit">
    <div class="like mbom40"><if condition="$sex_flag eq 'nan'"><a href="javascript:hg_gotoUrl('{:url('', array('sex_flag'=>'nv'))}');"  class="flrt" ><else/><a href="javascript:hg_gotoUrl('{:url('', array('sex_flag'=>'nan'))}');"  class="flrt" ></if><span class="ic_set  fllf" ><img src="__IMG__/ic_set.png" /></span>我喜欢看<if condition="$sex_flag eq 'nan'">女生<else/>男生</if>小说></a></div>
</div>
<!--我喜欢结束-->
</block>
<block name="script">
