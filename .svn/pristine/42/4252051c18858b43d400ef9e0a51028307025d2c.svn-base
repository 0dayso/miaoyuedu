...
<div class="h100 bgcf">
    ...
    <if condition="hsConfig.USERINFO.islogin eq 'TRUE'">
        <div class="left" onclick="go_url('User/index')"><img src="__IMG__/avater.jpg" class="avater"/></div>
        <div class="right perxinxi"></div>
        <div class="right2"><a class="ic_settings" href="javascript:void(0);" onclick="go_url('User/index')">设置</a></div>
        <div class="bom  cf fontsize16" onclick="go_url('User/index')">{$userinfo.nickname}</div>
    <else/>
         <div class="left" onclick="go_url('User/login')"><img src="__IMG__/avater.jpg" class="avater"/></div>
        <div class="right perxinxi"></div>
        <div class="right2"><a class="ic_settings" href="javascript:void(0);" onclick="go_url('User/login')">设置</a></div>
        <div class="bom  cf fontsize16" onclick="go_url('User/login')">登录</div>
    </if>
    </div>
    <div class="homecon  displaybox2  sidebarcon borderbottom1 ">
        <ul>
            <li onClick="go_url('Pay/index')">
                <div class="left"><span class="ic_wallet2 ic_tit"></span></div>
                <div class="right c87 fontsize14">快速充值</div>
            </li>
            <li onClick="go_url('User/qiandao')">
    ...
    <div class="homecon   displaybox2 sidebarcon">
        <ul>
            <li onClick="go_url('Channel/free')">
            ...
            <li onClick="go_url('Channel/tejia')">
