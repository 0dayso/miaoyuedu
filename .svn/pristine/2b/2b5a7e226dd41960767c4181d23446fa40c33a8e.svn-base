...
<div class="unit mtop10">
    ...
    <div class="frame5">
        <ul>
            <li onClick="hg_gotoUrl('{:url('User/changenickname')}')">昵称<span><em >{$userinfo['nickname']}</em><img src="__IMG__/ic_after.png" /></span></li>
            <li onClick="hg_gotoUrl('{:url('User/mobbind')}')">手机绑定<span><em >{$mobile}</em><img src="__IMG__/ic_after.png" /></span></li>
            <li onClick="hg_gotoUrl('{:url('User/changepwd')}')">密码修改<span><img src="__IMG__/ic_after.png" /></span></li>
...
function changeacount(){
   ...
   doClient({Action:'saveP30',P30:'',fu:url}) 
}
</script>
</block>