...
<block name="body">
    <div class="container mtop10 clearfix">
        <div class="crumbs crumbs2"><span href="javascript:void(0);">您的位置</span>><a href="{:url('Index/index','','html')}">首页</a>><span>{$aboutarticle.title}</span></div>
        <div class="news">
            <include file="tpl/newslist" />
            <div class="rt problem">
                <div class="news_tit news2_tit">
                    <h2>{$aboutarticle.title}</h2>
                    <div class="share"><span class="news2_tit_name">编辑名：{$aboutarticle.admin_name}</span><span class="news2_tit_name">{$aboutarticle.date}</span>
                ...
                <div class="newsrt_con">
                    ...
                    <div class="news2_zan share"><a href="javascript:void(0);" class="news2_zanbtn" id="zan">点赞({$aboutarticle.love})</a><a href="javascript:void(0);" id="share2"  class="news2_zanbtn" isshow="0">分享</a> <div class="sharemask radius4" id="sharebox2" style="display: none;">
                        <i class="arrow arrow-1"></i> <i class="arrow arrow-2"></i>
                        <a href="#" target="_blank" class="ic_rdset_weixin"></a>
                        <a href="#" target="_blank" class="ic_rdset_pyq"></a>
    ...
    <script type="text/javascript">
        require(['mod/help'],function(help){
            ...
            $('#zan').on('click',function(){
                help.sendzan('{$aboutarticle.article_id}','#zan');     
            })
        })
    </script>
</block>