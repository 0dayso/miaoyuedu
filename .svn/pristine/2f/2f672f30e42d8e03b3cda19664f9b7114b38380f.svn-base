...
<div class="login login2">
        ...
        <p id="button3" style="display:none;"><button id="zc" type="button" disabled="disabled" class="disable radius4" onclick="login();">绑定</button></p>
</div>
</block>
<block name="script">
...
function login(obj){
    ...
    lockbutton(obj);
    url="{:url('Userajax/savemobile','','do')}";
    $.ajax({
        url: url,
        type: "POST",
