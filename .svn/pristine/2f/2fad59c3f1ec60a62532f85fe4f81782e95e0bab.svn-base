...
<!--今日免费开始-->
<div class="unit">
    <div class="tit"><h1>今日免费</h1><a href="javascript:doChild('{:url('Channel/free',array('sex_flag'=>'nan'))}');" class="more">更多></a><span class="flrt mrt10"><em class="cred" id="timer"></em></span></div>
    <div class="frame2">
        <ul id="free1">
        </ul>
    </div>
...
<div class="unit ">
    <div class="frame4  clearfix">
        ...
        <foreach name="category" item="row">
            <li class="tag3" onClick="doChild('{:url('Channel/search',array('classid'=>$row['classid'],'sex_flag'=>'nan'))}')">{$row.title}</li>
        </foreach>
        </ul>
    </div>
</div>
...
<div class="unit">
    <div class="frame14 twobk clearfix">
        <ul>
            <li onClick="doChild('{:url('Channel/xinshu',array('sex_flag'=>'nan'))}');"><h2 class="cgreen">男频新书</h2><p>最新小说免费看</p></li>
            <li onClick="doChild('{:url('Channel/tejia',array('sex_flag'=>'nan'))}');"><h2 class="cyellow">天天特价</h2><p>好书5折起</p></li>
        </ul>
    </div>
</div>
<!--新书和免费结束-->
